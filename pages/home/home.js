...
Page({
  ...
  onShareAppMessage: function () {
    ...
    return {
      ...
      path: '/pages/home/home?userid=' + that.data.user.loginId ,
    ...
    app.res.req('/sqshopcart/add', data, (res) => {
      ...
      if (res.status == 1000) {
        ...
        setTimeout(() => {
          ...
          var urls = '/pages/home/home?id=' + storeid
  ...
  getcdetail() {
    ...
    app.res.req('/sqproduct/promotionproduct', data, (res) => {
      ...
      if (res.status == 1000) {
        ...
        res.data.map((item)=>{
          item.Ratio = (item.activityPrice * item.memberDeductionRatio).toFixed(2)
        })
        that.setData({
          detail: res.data
        })
    ...
    app.res.req('/sqproduct/storedetail', data, (res) => {
      ...
      if (res.status == 1000) {
        ...
        //that.getcart();
         ...
         wx.setStorageSync('urls', '/pages/home/home')
      } else {
        wx.showToast({
          title: res.msg,
          icon: 'none'
